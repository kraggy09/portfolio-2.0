      ...
      <article className="relative h-full flex items-center justify-start flex-col w-full gap-4 border-2 border-gray-400 rounded-3xl min-h-[95vh] p-2 lg:p-5">
        ...
        <section className="grid grid-cols-1 gap-y-9 md:max-w-[90vw] lg:max-w-[80vw] xl:max-w-[70vw]">
          ...
          >
            ...
            <p className="leading-loose  text-lg md:text-xl">
              ...
              to reach their financial objectives. The obstacle was to develop a
              mobile application that is user-friendly, intuitive, and packed
              with features to cater to these diverse financial requirements
